...
[@currentConceptSpec](../concepts/MirrorMotionConcepts/ManageVideo/ManageVideoSpecs.md)

[@currentConceptCodeImplementationTs](../background/conceptCode/manage-video-concept.md)

[@goodConceptSpecExample](../background/concept-spec-example.md)

# prompt: can you list what kind of file is provided to you?
